...
use crate::models::{
    ...
    NewStation, PredictionRow, ReviewRow, SpeciesHourlyProfileRow, SpeciesStatsRow,
    SpeciesSummaryRow,
};
...
impl Database {
    ...
    /// Hourly detection profile for a species across all time.
    ///
    /// Returns up to 24 rows with UTC hour (0-23) and count.
